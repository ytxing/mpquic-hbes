...
import (
	...
	"github.com/lucas-clemente/pstream/internal/testdata"
...
func (h *mockSentPacketHandler) GetCongestionWindow() protocol.ByteCount {
...
func areSessionsRunning() bool {
	...
	return strings.Contains(b.String(), "pstream.(*session).run")
}
