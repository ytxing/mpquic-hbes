...
def launchTests(times=5):
    ...
    mptcpTopos = 	[
		{'paths': [{'queuingDelay': '0.010', 'bandwidth': '10.0', 'delay': '10', 'jitter': '0'},{'queuingDelay': '0.023', 'bandwidth': '10.0', 'delay': '10', 'jitter': '0'}],'netem': [(0, 0, 'loss 0.00%'), (1, 0, 'loss 0.00%')]},
		]
